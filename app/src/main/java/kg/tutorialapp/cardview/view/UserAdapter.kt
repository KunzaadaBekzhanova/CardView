package kg.tutorialapp.cardview.view
...
import kg.tutorialapp.cardview.R
import kg.tutorialapp.cardview.model.UserData

class UserAdapter(val c: Context,var userList:ArrayList<UserData>):
